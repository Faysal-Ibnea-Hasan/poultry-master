...
class ExpenseController extends Controller
{
    ...
    public function expenses(Request $request)
    {
        if ($request->isMethod('GET')) {
            ...
            if ($request->feed_expense) {
                return $this->management->get_feed_expenses($request->batch_id, $request->feed_expense);
            }
            return $this->management->get_expenses($request->batch_id);
        } else {
            $validator = Validator::make($request->all(), [
